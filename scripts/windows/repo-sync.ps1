...
git add -A -- registry specs AUDIT.md MONITOR.md BOT_REGISTRY.md STATUS.md 2>$null
...
if($LASTEXITCODE -ne 0){
  ...
  git checkout --theirs -- registry specs AUDIT.md MONITOR.md BOT_REGISTRY.md STATUS.md 2>$null
