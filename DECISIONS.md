...
## D-115 — Discover new free models on the keyed providers too (2026-09-24) — VERIFIED (unit + live: gemini sweep 04:08 → `gemini-flash-lite-latest` probe 0.9 s, loop 2 s, integrated, benched 4/4 in 42 s; 6 others rejected on evidence: 404 gone, 503, no_tool_call)
